  ...
  class FormSteps {
    ...
    updateForm() {
      ...
      if(this.currentStep === 4) {
        ...
        console.log("Data odbioru: " + document.querySelector('#pickUpDate').value);
        console.log("Czas odbioru: " + document.querySelector('#pickUpTime').value);
        console.log("Komentarz: " + document.querySelector('#pickUpComment').value);
        console.log('****************************************************');
      }
